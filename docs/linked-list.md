...
- The linked list is implemented as a doubly linked list for efficient O(1) insertions and deletions at both ends.
- Iteration yields values from front to back.
- The `assign` method is overloaded for both count/value and array slice usage.
